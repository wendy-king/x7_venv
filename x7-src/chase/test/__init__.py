...
from chase.common.utils import readconf

setattr(__builtin__, '_', lambda x: x)


# Work around what seems to be a Python bug.
# c.f. https://bugs.launchpad.net/chase/+bug/820185.
import logging
...
def get_config():
    ...
    """
    config_file = os.environ.get('CHASE_TEST_CONFIG_FILE',
                                 '/etc/chase/func_test.conf')
    config = {}
    try:
        try:
