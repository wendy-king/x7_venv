...
from chase.proxy import server as proxy_server
from chase.account import server as account_server
from chase.container import server as container_server
from chase.obj import server as object_server
from chase.common import ring
from chase.common.constraints import MAX_META_NAME_LENGTH, \
    MAX_META_VALUE_LENGTH, MAX_META_COUNT, MAX_META_OVERALL_SIZE, MAX_FILE_SIZE
from chase.common.utils import mkdirs, normalize_timestamp, NullLogger
from chase.common.wsgi import monkey_patch_mimetools
...
def setup():
    ...
    conf = {'devices': _testdir, 'chase_dir': _testdir,
...
class TestProxyServer(unittest.TestCase):
    ...
    def test_access_log(self):
        ...
        try:
            ...
            print line
            self.assert_(line.startswith('chase'))
    ...
    def test_calls_authorize_allow(self):
        ...
        with save_globals():
            ...
            req.environ['chase.authorize'] = authorize
            app.update_request(req)
            resp = app.handle_request(req)
...
class TestObjectController(unittest.TestCase):
    ...
    def test_custom_mime_types_files(self):
        chase_dir = mkdtemp()
        try:
            with open(os.path.join(chase_dir, 'mime.types'), 'w') as fp:
                fp.write('foo/bar foo\n')
            ba = proxy_server.BaseApplication({'chase_dir': chase_dir},
            ...
            rmtree(chase_dir, ignore_errors=True)
    ...
    def test_chunked_put(self):
        ...
        with save_globals():
            ...
            from chase.proxy import server
            proxy_server.http_connect = fake_http_connect(201, 201, 201, 201)
            req = Request.blank('/a/c/o', environ={'REQUEST_METHOD': 'COPY'},
                headers={'Transfer-Encoding': 'chunked',
                'Content-Type': 'foo/bar'})
...
class TestContainerController(unittest.TestCase):
    "Test chase.proxy_server.ContainerController"
    ...
    def test_POST_calls_clean_acl(self):
        ...
        with save_globals():
            ...
            req.environ['chase.clean_acl'] = clean_acl
            self.app.update_request(req)
            res = controller.POST(req)
        self.assert_(called[0])
        called[0] = False
