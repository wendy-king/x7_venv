...
from chase.common.middleware import chase3
...
class TestChase3(unittest.TestCase):
    def setUp(self):
    ...
    def test_bucket_PUT(self):
        local_app = chase3.filter_factory({})(FakeAppBucket(201))
    ...
    def test_bucket_DELETE(self):
        local_app = chase3.filter_factory({})(FakeAppBucket(204))
        req = Request.blank('/bucket',
    ...
    def test_canonical_string(self):
        ...
        def verify(hash, path, headers):
            ...
            self.assertEquals(hash,
                    hashlib.md5(chase3.canonical_string(req)).hexdigest())
        ...
        self.assertEquals(chase3.canonical_string(req1),
                chase3.canonical_string(req2))
        self.assertEquals(chase3.canonical_string(req2),
                chase3.canonical_string(req3))
