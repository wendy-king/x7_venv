...
from chase.common.middleware import staticweb
...
class TestStaticWeb(unittest.TestCase):
    ...
    def test_container4unknown_memcache(self):
        ...
        resp = Request.blank('/v1/a/c4',
            environ={'chase.cache': fake_memcache}
        ...
        self.assertEquals(fake_memcache.store,
           {'/staticweb/v1/a/c4':
                ('index.html', 'error.html', 't', 'listing.css')})
        resp = Request.blank('/v1/a/c4',
            environ={'chase.cache': fake_memcache, 'REQUEST_METHOD': 'PUT'}
        ).get_response(self.test_staticweb)
        self.assertEquals(resp.status_int, 200)
        self.assertEquals(fake_memcache.store, {})
        resp = Request.blank('/v1/a/c4',
        ...
        self.assertEquals(fake_memcache.store,
           {'/staticweb/v1/a/c4':
                ('index.html', 'error.html', 't', 'listing.css')})
        resp = Request.blank('/v1/a/c4',
            environ={'chase.cache': fake_memcache, 'REQUEST_METHOD': 'POST'}
        ).get_response(self.test_staticweb)
        self.assertEquals(resp.status_int, 200)
        self.assertEquals(fake_memcache.store, {})
