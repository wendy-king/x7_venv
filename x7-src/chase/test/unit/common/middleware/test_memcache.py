...
from chase.common.middleware import memcache
from chase.common.memcached import MemcacheRing
...
class TestCacheMiddleware(unittest.TestCase):
    ...
    def test_cache_middleware(self):
        ...
        self.assertTrue('chase.cache' in resp)
        self.assertTrue(isinstance(resp['chase.cache'], MemcacheRing))
    ...
    def test_conf_default_read(self):
        ...
        self.assertEquals(str(exc),
            "read called with '/etc/chase/memcache.conf'")
