...
import chase.common.db
from chase.common.db import AccountBroker, chexor, ContainerBroker, \
    DatabaseBroker, DatabaseConnectionError, dict_factory, get_db_connection
from chase.common.utils import normalize_timestamp
from chase.common.exceptions import LockTimeout
...
class TestDatabaseBroker(unittest.TestCase):
    ...
    def test_get(self):
        ...
        orig_renamer = chase.common.db.renamer
        try:
            chase.common.db.renamer = lambda a, b: b
            ...
            chase.common.db.renamer = orig_renamer
...
class TestContainerBroker(unittest.TestCase):
    """ Tests for chase.common.db.ContainerBroker """

    def test_creation(self):
        """ Test chase.common.db.ContainerBroker.__init__ """
    ...
    def test_exception(self):
        """ Test chase.common.db.ContainerBroker throwing a conn away after
            unhandled exception """
        first_conn = None
        broker = ContainerBroker(':memory:', account='a', container='c')
        broker.initialize(normalize_timestamp('1'))
    ...
    def test_empty(self):
        """ Test chase.common.db.ContainerBroker.empty """
        broker = ContainerBroker(':memory:', account='a', container='c')
        broker.initialize(normalize_timestamp('1'))
    ...
    def test_delete_object(self):
        """ Test chase.common.db.ContainerBroker.delete_object """
        broker = ContainerBroker(':memory:', account='a', container='c')
        broker.initialize(normalize_timestamp('1'))
        broker.put_object('o', normalize_timestamp(time()), 0, 'text/plain',
                          'd41d8cd98f00b204e9800998ecf8427e')
    ...
    def test_put_object(self):
        """ Test chase.common.db.ContainerBroker.put_object """
        broker = ContainerBroker(':memory:', account='a', container='c')
        broker.initialize(normalize_timestamp('1'))
    ...
    def test_get_info(self):
        """ Test chase.common.db.ContainerBroker.get_info """
    ...
    def test_list_objects_iter(self):
        """ Test chase.common.db.ContainerBroker.list_objects_iter """
        broker = ContainerBroker(':memory:', account='a', container='c')
        broker.initialize(normalize_timestamp('1'))
    ...
    def test_double_check_trailing_delimiter(self):
        """ Test chase.common.db.ContainerBroker.list_objects_iter for a
...
def premetadata_create_container_stat_table(self, conn, put_timestamp=None):
    """
    Copied from chase.common.db.ContainerBroker before the metadata column was
...
class TestContainerBrokerBeforeMetadata(TestContainerBroker):
    """
    Tests for chase.common.db.ContainerBroker against databases created before
...
def prexsync_create_container_stat_table(self, conn, put_timestamp=None):
    """
    Copied from chase.common.db.ContainerBroker before the
...
class TestAccountBroker(unittest.TestCase):
    """ Tests for chase.common.db.AccountBroker """

    def test_creation(self):
        """ Test chase.common.db.AccountBroker.__init__ """
    ...
    def test_exception(self):
        """ Test chase.common.db.AccountBroker throwing a conn away after
            exception """
        first_conn = None
        broker = AccountBroker(':memory:', account='a')
        broker.initialize(normalize_timestamp('1'))
    ...
    def test_empty(self):
        """ Test chase.common.db.AccountBroker.empty """
        broker = AccountBroker(':memory:', account='a')
        broker.initialize(normalize_timestamp('1'))
        self.assert_(broker.empty())
    ...
    def test_delete_container(self):
        """ Test chase.common.db.AccountBroker.delete_container """
        broker = AccountBroker(':memory:', account='a')
        broker.initialize(normalize_timestamp('1'))
        broker.put_container('o', normalize_timestamp(time()), 0, 0, 0)
        with broker.get() as conn:
    ...
    def test_get_container_timestamp(self):
        """ Test chase.common.db.AccountBroker.get_container_timestamp """
        broker = AccountBroker(':memory:', account='a')
        broker.initialize(normalize_timestamp('1'))
    ...
    def test_put_container(self):
        """ Test chase.common.db.AccountBroker.put_container """
        broker = AccountBroker(':memory:', account='a')
        broker.initialize(normalize_timestamp('1'))
    ...
    def test_get_info(self):
        """ Test chase.common.db.AccountBroker.get_info """
    ...
    def test_list_containers_iter(self):
        """ Test chase.common.db.AccountBroker.list_containers_iter """
        broker = AccountBroker(':memory:', account='a')
        broker.initialize(normalize_timestamp('1'))
    ...
    def test_double_check_trailing_delimiter(self):
        """ Test chase.common.db.AccountBroker.list_containers_iter for an
...
def premetadata_create_account_stat_table(self, conn, put_timestamp):
    """
    Copied from chase.common.db.AccountBroker before the metadata column was
...
class TestAccountBrokerBeforeMetadata(TestAccountBroker):
    """
    Tests for chase.common.db.AccountBroker against databases created before
    the metadata column was added.
    """
