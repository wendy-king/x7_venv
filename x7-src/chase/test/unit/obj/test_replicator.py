...
from chase.common import utils
from chase.common.utils import hash_path, mkdirs, normalize_timestamp
from chase.common import ring
from chase.obj import replicator as object_replicator
from chase.obj.server import DiskFile
...
class TestObjectReplicator(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.conf = dict(
            chase_dir=self.testdir, devices=self.devices, mount_check='false',
