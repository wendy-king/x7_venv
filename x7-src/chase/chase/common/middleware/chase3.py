...
"""
The chase3 middleware will emulate the S3 REST api on top of chase.
...
To add this middleware to your configuration, add the chase3 middleware
in front of the auth middleware, and before any other middleware that
look at chase requests (like rate limiting).
...
to the chase storage hostname.  It also will have to use the old style
...
from chase.common.utils import split_path
...
class Chase3Middleware(object):
    """Chase3 S3 compatibility midleware"""
...
def filter_factory(global_conf, **local_conf):
    ...
    def chase3_filter(app):
        return Chase3Middleware(app, conf)

    return chase3_filter
