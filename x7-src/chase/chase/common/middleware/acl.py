...
from chase.common.utils import urlparse


def clean_acl(name, value):
    """
    Returns a cleaned ACL header value, validating that it meets the formatting
    requirements for standard Chase ACL strings.
...
def parse_acl(acl_string):
    """
    Parses a standard Chase ACL string into a referrers list and groups list.

    See :func:`clean_acl` for documentation of the standard Chase ACL format.

    :param acl_string: The standard Chase ACL string to parse.
