...
from chase.common import exceptions
from chase.common.ring import RingData


class RingBuilder(object):
    """
    Used to build chase.common.RingData instances to be written to disk and
    used with chase.common.ring.Ring instances. See bin/ring-builder.py for
    example usage.
    ...
    def get_ring(self):
        """
        Get the ring, or more specifically, the chase.common.ring.RingData.
