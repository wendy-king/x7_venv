...
from chase.common.client import ClientException, delete_object, put_object, \
    quote
from chase.common.direct_client import direct_get_object
from chase.common.ring import Ring
from chase.common.db import ContainerBroker
from chase.common.utils import audit_location_generator, get_logger, \
...
class ContainerSync(Daemon):
    ...
    :param container_ring: If None, the <chase_dir>/container.ring.gz will be
                           loaded. This is overridden by unit tests.
    :param object_ring: If None, the <chase_dir>/object.ring.gz will be loaded.
