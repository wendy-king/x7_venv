...
from chase.common.utils import mkdirs, normalize_timestamp, \
    storage_directory, hash_path, renamer, fallocate, \
    split_path, drop_buffer_cache, get_logger, write_pickle
from chase.common.bufferedhttp import http_connect
from chase.common.constraints import check_object_creation, check_mount, \
    check_float, check_utf8
from chase.common.exceptions import ConnectionTimeout, DiskFileError, \
    DiskFileNotExist
from chase.obj.replicator import tpooled_get_hashes, invalidate_hash, \
    quarantine_renamer
...
PICKLE_PROTOCOL = 2
METADATA_KEY = 'user.chase.metadata'
...
class ObjectController(object):
    """Implements the WSGI application for the Chase Object Server."""
    ...
    def POST(self, request):
        """Handle HTTP POST requests for the Chase Object Server."""
        try:
