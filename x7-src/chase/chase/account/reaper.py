...
from chase.account.server import DATADIR
from chase.common.db import AccountBroker
from chase.common.direct_client import ClientException, \
    direct_delete_container, direct_delete_object, direct_get_container
from chase.common.ring import Ring
from chase.common.utils import get_logger, whataremyips
...
class AccountReaper(Daemon):
    ...
    def get_account_ring(self):
        """ The account :class:`chase.common.ring.Ring` for the cluster. """
    ...
    def reap_account(self, broker, partition, nodes):
        ...
        .. seealso::
            ...
            :class:`chase.common.db.AccountBroker` for the broker class.

        .. seealso::

            :func:`chase.common.ring.Ring.get_nodes` for a description
            of the node dicts.
        """
        begin = time()
