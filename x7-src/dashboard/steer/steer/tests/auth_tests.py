...
SYSPANEL_INDEX_URL = reverse('steer:syspanel:overview:index')
DASH_INDEX_URL = reverse('steer:engine:overview:index')
...
class AuthViewTests(test.BaseViewTests):
    ...
    def test_login_index(self):
        res = self.client.get(reverse('steer:auth_login'))
    ...
    def test_switch_tenants_index(self):
        res = self.client.get(reverse('steer:auth_switch',
    ...
    def test_logout(self):
        ...
        res = self.client.get(reverse('steer:auth_logout'))
