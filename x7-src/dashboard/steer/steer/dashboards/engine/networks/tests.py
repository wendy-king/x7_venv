...
class NetworkViewTests(test.BaseViewTests):
    ...
    def test_network_create(self):
        ...
        res = self.client.post(reverse('steer:engine:networks:create'),
                               formData)
...
class PortViewTests(test.BaseViewTests):
    ...
    def test_port_create(self):
        ...
        res = self.client.post(reverse('steer:engine:networks:port_create',
                                       args=["n1"]),
                               formData)
    ...
    def test_port_delete(self):
        ...
        res = self.client.post(reverse('steer:engine:networks:detail',
                                       args=["n1"]),
                               formData)
