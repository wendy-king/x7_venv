...
from steer.dashboards.engine.networks.forms import (CreateNetwork,
...
def port_create(request, network_id):
    ...
    if handled:
        return shortcuts.redirect('steer:engine:networks:detail',
                                  network_id=network_id)

    return shortcuts.render(request,
                            'engine/ports/create.html', {
                                'network_id': network_id,
