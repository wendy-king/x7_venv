...
from steer.dashboards.engine.instances_and_volumes.instances.forms import \
                            (TerminateInstance, RebootInstance, UpdateInstance)
from steer.dashboards.engine.instances_and_volumes.volumes.forms import \
...
def index(request):
    ...
    return shortcuts.render(request, 'engine/instances_and_volumes/index.html', {
                                     'instances': instances,
