...
"""
Views for managing Engine volumes.
"""
...
from steer.dashboards.engine.instances_and_volumes.volumes.forms \
...
def index(request):
    ...
    return shortcuts.render(request,
                            'engine/instances_and_volumes/volumes/index.html', {
                                'volumes': volumes,
...
def detail(request, volume_id):
    ...
    return shortcuts.render(request,
                            'engine/instances_and_volumes/volumes/detail.html', {
                                'volume': volume,
...
def create(request):
    ...
    return shortcuts.render(request,
                            'engine/instances_and_volumes/volumes/create.html', {
                                'create_form': create_form})
