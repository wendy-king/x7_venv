...
class InstanceViewTests(test.BaseViewTests):
    ...
    def test_instance_usage(self):
        ...
        res = self.client.get(
                reverse('steer:engine:instances_and_volumes:instances:usage'))

        self.assertTemplateUsed(res,
                'engine/instances_and_volumes/instances/usage.html')
    ...
    def test_instance_csv_usage(self):
        ...
        self.assertTemplateUsed(res,
                'engine/instances_and_volumes/instances/usage.csv')
