...
from steer.dashboards.engine.access_and_security.floating_ips.forms import \
                                                            FloatingIpAssociate
...
class FloatingIpViewTests(test.BaseViewTests):
    ...
    def test_associate(self):
        ...
        self.assertTemplateUsed(res,
                        'engine/access_and_security/floating_ips/associate.html')
    ...
    def test_associate_post_with_exception(self):
        ...
        res = self.client.post(reverse(
                'steer:engine:access_and_security:floating_ips:associate',
                args=[1]),
                {'instance_id': 1,
                 'floating_ip_id': self.floating_ip.id,
                 'floating_ip': self.floating_ip.ip,
