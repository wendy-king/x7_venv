...
class CreateGroup(tables.LinkAction):
    ...
    url = "steer:engine:access_and_security:security_groups:create"
...
class EditRules(tables.LinkAction):
    ...
    url = "steer:engine:access_and_security:security_groups:edit_rules"
    ...
    def single(self, table, request, obj_id):
        ...
        try:
            ...
            messages.error(request, _('Error authorizing security group: %s')
                                     % e.message)
        return shortcuts.redirect('steer:engine:access_and_security:'
