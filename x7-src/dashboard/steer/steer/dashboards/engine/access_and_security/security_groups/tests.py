...
SECGROUP_ID = '2'
INDEX_URL = reverse('steer:engine:access_and_security:index')
SG_CREATE_URL = \
            reverse('steer:engine:access_and_security:security_groups:create')
SG_EDIT_RULE_URL = \
        reverse('steer:engine:access_and_security:security_groups:edit_rules',
                           args=[SECGROUP_ID])
...
class SecurityGroupsViewTests(test.BaseViewTests):
    def setUp(self):
        ...
        self.rules = [api.engine.SecurityGroupRule(rule)]
    ...
    def test_create_security_groups_get(self):
        ...
        self.assertTemplateUsed(res,
                        'engine/access_and_security/security_groups/create.html')
