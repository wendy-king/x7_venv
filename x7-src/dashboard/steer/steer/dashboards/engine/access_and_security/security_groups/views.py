...
class EditRulesView(tables.DataTableView):
    ...
    template_name = 'engine/access_and_security/security_groups/edit_rules.html'
    ...
    def get_data(self):
        ...
        try:
            self.object = api.security_group_get(self.request,
                                                security_group_id)
            rules = [api.engine.SecurityGroupRule(rule) for
...
class CreateView(forms.ModalFormView):
    ...
    template_name = 'engine/access_and_security/security_groups/create.html'
