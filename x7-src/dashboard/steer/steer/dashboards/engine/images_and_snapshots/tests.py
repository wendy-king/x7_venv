...
INDEX_URL = reverse('steer:engine:images_and_snapshots:index')
...
class ImagesAndSnapshotsTests(test.BaseViewTests):
    ...
    def test_index_no_images(self):
        ...
        self.assertTemplateUsed(res, 'engine/images_and_snapshots/index.html')

    def test_index_client_conn_error(self):

        self.mox.StubOutWithMock(api, 'image_list_detailed')
        exception = tank_exception.ClientConnectionError('clientConnError')
