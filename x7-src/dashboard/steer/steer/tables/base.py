...
class Column(object):
    ...
    def get_data(self, datum):
        ...
        or the return value of the attr:`~steer.tables.Column.transform`
...
class Cell(object):
    ...
    def value(self):
        ...
        :attr:`~steer.tables.Column.link`` and
        :attr:`~steer.tables.Column.empty_value`
        attributes.
        """
        try:
...
class DataTableOptions(object):
    ...
    .. attribute:: template
        ...
        table. Defaults to ``"steer/common/_data_table.html"``.
    ...
    def __init__(self, options):
        ...
        self.template = 'steer/common/_data_table.html'
        self.row_actions_template = \
                        'steer/common/_data_table_row_actions.html'
        self.table_actions_template = \
                        'steer/common/_data_table_table_actions.html'
...
class DataTable(object):
    ...
    .. attribute:: filtered_data
        ...
        the :meth:`~steer.tables.FilterAction.filter` method of the table's
        :class:`~steer.tables.FilterAction` class (if one is provided)
    ...
    def get_object_by_id(self, lookup):
        ...
        Uses :meth:`~steer.tables.DataTable.get_object_id` internally.
        """
