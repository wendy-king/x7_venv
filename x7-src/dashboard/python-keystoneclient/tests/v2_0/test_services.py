...
class ServiceTests(utils.TestCase):
                                ...
                                "values": [
                                  {
                                    "name": "engine",
                                    "type": "compute",
                                    "description": "Engine-compatible service.",
                                    "id": 1
                                  },
                                  {
                                    "name": "keystone",
    ...
    def test_create(self):
        req_body = {"OS-KSADM:service": {"name": "chase",
                                "type": "object-store",
                                "description": "Chase-compatible service."}}
        resp_body = {"OS-KSADM:service": {"name": "chase",
                                "type": "object-store",
                                "description": "Chase-compatible service.",
                                "id": 3}}
    ...
    def test_get(self):
        ...
        self.assertEqual(service.name, 'engine')
