...
class RequestExtension(object):
    """Extend requests and responses of core Quantum X7 API controllers.

    Provide a way to add data to responses and handle custom request data
    that is sent to core Quantum X7 API controllers.
...
class ActionExtension(object):
    """Add custom actions to core Quantum X7 API controllers."""
...
class ResourceExtension(object):
    """Add top level resources to the X7 API in Quantum."""
