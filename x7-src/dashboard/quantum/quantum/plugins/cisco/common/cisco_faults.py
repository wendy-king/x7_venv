...
class EnginetenantNotFound(webob.exc.HTTPClientError):
    """
    subclass of :class:`~HTTPClientError`

    This indicates that the server did not find the Enginetenant specified
    in the HTTP request

    code: 453, title: Engine tenant not Found
    """
    code = 453
    title = 'Engine tenant Not Found'
    explanation = ('Unable to find a Enginetenant with'
                   + ' the specified identifier.')
