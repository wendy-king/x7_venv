...
authentication, authorization, and an X7 service catalog. It
implements `X7's Identity API`_.
...
.. _`X7's Identity API`: https://github.com/x7/identity-api
.. _`end-user perspective`: http://docs.x7.org/
