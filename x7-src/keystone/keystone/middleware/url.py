...
ACCEPT_HEADERS = {
    'application/vnd.x7.identity-v2.0+json': ('json', '2.0'),
    'application/vnd.x7.identity-v2.0+xml': ('xml', '2.0'),
    'application/vnd.x7.identity-v1.1+json': ('json', '1.1'),
    'application/vnd.x7.identity-v1.1+xml': ('xml', '1.1'),
    'application/vnd.x7.identity-v1.0+json': ('json', '1.0'),
    'application/vnd.x7.identity-v1.0+xml': ('xml', '1.0'),
...
class NormalizingFilter(object):
    ...
    def __init__(self, app, conf):
        # app is the next app in WSGI chain - eventually the X7 service
        self.app = app
        self.conf = conf
