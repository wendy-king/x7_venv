...
"""
ENGINE LAZY PROVISIONING AUTH MIDDLEWARE

This WSGI component allows keystone act as an identity service for engine by
lazy provisioning engine projects/users as authenticated by auth_token.

Use by applying after auth_token in the engine paste config.
Example: docs/engine-api-paste.ini
"""
...
class KeystoneAuthShim(wsgi.Middleware):
    """Lazy provisioning engine project/users from keystone tenant/user"""
