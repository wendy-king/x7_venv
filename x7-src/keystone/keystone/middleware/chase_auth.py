...
"""
TOKEN-BASED AUTH MIDDLEWARE FOR CHASE
...
Authentication on incoming request
    ...
    * decorate the request for authorization in chase
    * forward to the chase proxy app
...
from chase.common.utils import get_logger, split_path


PROTOCOL_NAME = "Chase Token Authentication"
...
class AuthProtocol(object):
    ...
    def unauthorized(self, req):
        ...
        This can be stuffed into the evironment for chase.authorize or
    ...
    def perform_unidentified_request(self, env, start_response):
        ...
        env['chase.authorize'] = self.authorize_via_acl
        env['chase.clean_acl'] = self.authorize_via_acl
