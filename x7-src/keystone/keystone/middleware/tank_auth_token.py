...
"""
Tank Keystone Integration Middleware

This WSGI component allows keystone to act as an identity service for
tank.  Tank now supports the concept of images owned by a tenant,
and this middleware takes the authentication information provided by
auth_token and builds a tank-compatible context object.

Use by applying after auth_token in the tank-api.ini and
tank-registry.ini configurations, replacing the existing context
middleware.

Example: examples/paste/tank-api.conf,
    examples/paste/tank-registry.conf
"""
