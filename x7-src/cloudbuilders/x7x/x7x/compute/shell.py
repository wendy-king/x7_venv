...
class ComputeShell(object):
    ...
    def __init__(self):
        self.parser = argparse.ArgumentParser(
            ...
            epilog = 'See "x7-compute help COMMAND" for help on a specific command.',
            add_help = False,
        ...
        self.parser.add_argument('-f', '--config-file',
            metavar = 'PATH',
            default = None,
            help = 'Path to config file (default: ~/.x7/compute.conf)')
        ...
        self.parser.add_argument('--cloud-api',
            help = "API of the cloud service to be managed: either RACKSPACE or X7")
    ...
    @arg('--ipgroup',
         default = None,
         metavar = '<group>',
         help = "IP group name or ID (see 'cloudservers ipgroup-list'). DEPRICATED in X7")
    @arg('--meta',
         metavar = "<key=value>",
         action = 'append',
         default = [],
