...
class PrivilegedServerController(x7_api.servers.Controller):
    ...
    def index(self, req):
        ...
        # KLUDGE to make this extension working with different engine branches
...
def downgrade_context(f):
    def new_f(*args, **kwargs):
        context = kwargs['req'].environ['engine.context']
...
class ExtrasFlavorController(x7_api.flavors.Controller):
...
class AdminNetworkController(object):
    ...
    # TODO: implement full CRUD, not done right in engine too
