...
from x7.compute.backup_schedules import (BackupSchedule, BackupScheduleManager,
...
from x7.compute.client import ComputeClient
from x7.compute.exceptions import (ComputeException, BadRequest, Unauthorized,
    Forbidden, NotFound, OverLimit)
from x7.compute.flavors import FlavorManager, Flavor
from x7.compute.images import ImageManager, Image
from x7.compute.ipgroups import IPGroupManager, IPGroup
from x7.compute.servers import ServerManager, Server, REBOOT_HARD, REBOOT_SOFT
from x7.compute.api import API_OPTIONS

DEFAULT_CONFIG_FILE = os.path.expanduser('~/.x7/compute.conf')
...
class Config(object):
    ...
    DEFAULTS = {
        ...
        'user_agent': 'python-x7-compute/%s' % __version__,
        'allow_cache': False,
        'cloud_api' : 'RACKSPACE',
    }

    def __init__(self, config_file, env, overrides, env_prefix="X7_COMPUTE_"):
    ...
    def update_config_from_file(self, config_file):
        ...
        for section in ('global', 'compute', 'x7.compute'):
