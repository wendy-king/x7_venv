...
import mock
import x7.compute.base
from x7.compute import Flavor
from x7.compute.exceptions import NotFound
from x7.compute.base import Resource
...
def test_getid():
    assert_equal(x7.compute.base.getid(4), 4)
    class O(object):
        id = 4
    assert_equal(x7.compute.base.getid(O), 4)
